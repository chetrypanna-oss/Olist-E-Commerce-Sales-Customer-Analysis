...
**Delivery reliability affects reviews.** Since delivery performance is linked to review scores, prioritizing on-time delivery in the ~11% of orders that are late could meaningfully lift average review scores and repeat purchase rates.

**Concentrate marketing spend in São Paulo (SP)** and similar high-revenue states, where acquisition cost per customer is likely lower due to existing demand density.
